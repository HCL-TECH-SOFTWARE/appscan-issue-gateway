...
class VSTSProviderV2 implements IProvider {
	...
	[
		...
		'(Optional)' + SEVERITYMAP + ': Map of AppScan Severities to VSTS Priorities.  If set, a mapping must be provided for High, Medium, Low, Informational'.In case of ASE Informational must be replaced with Information,
