...
class RTCProviderV2 implements IProvider {
	...
	[
		...
		'(Optional)' + DESCRIPTION  + ': Override default issue description. Issue attributes can be included with %% substitution variables For example the default is \'<b>Security issue:</b> %IssueType%<br></br> <b>Scanner:</b> %Scanner%.\'',
